<template>
    <jet-action-section>
        ...
        <template #description>
            Управляйте и закрывайте свои активные сессии для других браузеров и устройств.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Если необходимо, Вы можете прервать све свои сессии на всех своих устройствах. Некоторые из сессий представлены ниже. Если Вы думаете, что Ваш аккаунт мог быть скомпрометирован, Вы можете так же поменять пароль.
            </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Пожалуйста, введите Ваш пароль, чтобы подтвердить, что Вы хотите прервать все сессии во всех остальных браузерах и устройствах.
