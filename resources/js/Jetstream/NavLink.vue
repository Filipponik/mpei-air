...
<script>
    export default {
        ...
        computed: {
            classes() {
                return this.active
                            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-indigo-400 text-sm font-medium leading-5  text-gray-500 hover:text-gray-700 focus:text-gray-700 focus:outline-none focus:border-indigo-700 transition'
